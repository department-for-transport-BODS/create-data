...
export const SERVICE_EMAIL_ADDRESS = process.env.SERVICE_EMAIL_ADDRESS ?? null;
export const SUPPORT_EMAIL_ADDRESS = process.env.SUPPORT_EMAIL_ADDRESS || 'support@example.com';
export const SUPPORT_PHONE_NUMBER = process.env.SUPPORT_PHONE_NUMBER ?? null;
